...
export default function HomePage() {
  return (
    <div id="home">
      ...
      <h1>A News Site With Next</h1>
      <p>
        Wong News is here to deliver you all the latest news - concise &
        unbiased!
      </p>

      <p>
        WongNews aims to provide you with the latest news in a concise and
